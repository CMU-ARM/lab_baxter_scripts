...
# Edit by Zhi to include both our baxter. The hostname is configured
# for our robots
...
##Zhi's edit, some code to change between baxter easily
if [ "${1}" == "b2" ]; then
	baxter_hostname="${baxter_2_hostname}"
fi
